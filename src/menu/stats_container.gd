...
func connect_signals():
    PlayerSignals.player_hp_new.connect(set_hp_label)
    PlayerSignals.player_mp_new.connect(set_mp_label)
    PlayerSignals.player_level_new.connect(set_level_label)
    PlayerSignals.player_exp_new.connect(set_exp_label)
    PlayerSignals.player_limit_new.connect(set_limit_label)
    PlayerSignals.player_strength_new.connect(set_strength_label)
    PlayerSignals.player_wisdom_new.connect(set_wisdom_label)
    PlayerSignals.player_defense_new.connect(set_defense_label)
    PlayerSignals.player_gold_new.connect(set_gold_label)
